	...
	m.addEventListener("mouseenter", () => {
		if (!m.classList.contains("hasBoard")) {
			if (!isMobileDevice()) {
				...
				m.innerHTML = `${m.innerHTML}<div class="board" data-pos="${m.dataset.pos}" data-border="10px" data-size="25vh" style="position:absolute;top:calc(${m.offsetTop}px - 27vh + 45px);left:${m.offsetLeft}px"></div>`;
